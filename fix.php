...
<body>
    <div class="header">
        <p>รายการสินค้า</p>
        <a name="" id="" class="button-logout" href="logout.php" role="button">ออกจากระบบ</a>
    </div>
    <div class="container">
        <h1>รายการสินค้า :</h1>
        <h2>ชื่อ :  <?php echo $username ?></h2>
    </div>
    ...
    <div class="fixproduct">
        <form method="POST" action="main/fix.php">
            ...
            <div class="form-button">
                <button type="submit" class="modify" style="float:right">แก้ไข</button>
                <a name="" id="" class="return" href="list.php" role="button" style="float:left">ย้อนกลับ</a>
            </div>
        </form>
    </div>
    <?php
